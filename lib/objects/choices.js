...
Choices.prototype.getChoice = function (selector) {
  assert(utils._.isNumber(selector));
...
Choices.prototype.where = function (whereClause) {
  return utils._.where(this.realChoices, whereClause);
};
...
Choices.prototype.pluck = function (propertyName) {
  return utils._.pluck(this.realChoices, propertyName);
};
...
Choices.prototype.push = function () {
  var objs = utils._.map(arguments, function (val) {
